...
// 此处仅演示了扩展accounts-password相关方法，扩展其他方法类似
// 内部代码复制于https://github.com/meteor/meteor/blob/devel/packages/accounts-password/password_client.js
// 仅将扩展对象改为参数Accounts，并修改了几处对Meteor对象的引用

export default function extendAccounts(Accounts) {
      ...
      function(error, result) {
        if (error || !result) {
          if (error && error.error === 400 &&
            ...
            srpUpgradePath({
              upgradeError: error,
              userSelector: { id: Accounts.userId() },
